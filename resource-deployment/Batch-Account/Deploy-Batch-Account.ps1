Function DeployBatchAccount
{
    ...
    param(
     ...
     [string]
     $templateFilePath = "batch-account.template.json",

     [string]
     $parametersFilePath = "batch-account.parameters.json"
    )
    ...
    # Register RPs
    $resourceProviders = @("microsoft.batch");
    ...
    Write-Host "Starting deployment of Azure Batch Account...";
    try {
        ...
        Write-Host "Deployment Successful of Azure Batch Account...";
    }
    catch {
