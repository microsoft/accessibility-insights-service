...
sed -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsConnectionString@" -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsAuthString@" -e "s@%KEY_VAULT_TOKEN%@$keyVaultUrl@" -e "s@%CONTAINER_REGISTRY_TOKEN%@$containerRegistryName@" "$templatesFolder/on-demand-url-scan-schedule.template.json" >"$parsedOnDemandScanScheduleFileName"
sed -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsConnectionString@" -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsAuthString@" -e "s@%KEY_VAULT_TOKEN%@$keyVaultUrl@" -e "s@%CONTAINER_REGISTRY_TOKEN%@$containerRegistryName@" "$templatesFolder/on-demand-scan-req-schedule.template.json" >"$parsedOnDemandScanReqScheduleFileName"
sed -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsConnectionString@" -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsAuthString@" -e "s@%KEY_VAULT_TOKEN%@$keyVaultUrl@" -e "s@%CONTAINER_REGISTRY_TOKEN%@$containerRegistryName@" "$templatesFolder/on-demand-send-notification-schedule.template.json" >"$parsedOnDemandSendNotificationFileName"
sed -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsConnectionString@" -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsAuthString@" -e "s@%KEY_VAULT_TOKEN%@$keyVaultUrl@" -e "s@%CONTAINER_REGISTRY_TOKEN%@$containerRegistryName@" "$templatesFolder/privacy-scan-schedule.template.json" >"$parsedPrivacyScanScheduleFileName"
sed -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsConnectionString@" -e "s@%APP_INSIGHTS_CONNECTION_STRING%@$appInsightsAuthString@" -e "s@%KEY_VAULT_TOKEN%@$keyVaultUrl@" -e "s@%CONTAINER_REGISTRY_TOKEN%@$containerRegistryName@" "$templatesFolder/report-generator-schedule.template.json" >"$parsedReportGeneratorScheduleFileName"
