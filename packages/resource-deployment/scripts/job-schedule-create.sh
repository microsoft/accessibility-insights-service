...
onDemandScanScheduleJobName="on-demand-scan-schedule"
parsedOnDemandScanScheduleFileName="on-demand-scan-schedule.generated.template.json"
...
sed -e "s@%APP_INSIGHTS_TOKEN%@$appInsightsKey@" -e "s@%KEY_VAULT_TOKEN%@$keyVaultUrl@" "$templatesFolder/on-demand-scan-schedule.template.json" >"$parsedOnDemandScanScheduleFileName"
