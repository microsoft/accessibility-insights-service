...
# This script will grant permissions to the system-assigned managed identity to access key vault
...
# Grant permissions to the VMSS system-assigned managed identity
