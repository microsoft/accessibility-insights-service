...
# Commenting out empty template files, since each action adds 30-40 secs of deployment time.
# We may need to have a single ARM template to improve performance.
