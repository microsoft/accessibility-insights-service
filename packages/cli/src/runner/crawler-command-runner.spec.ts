...
import { ApifyMainFunc, CrawlerCommandRunner } from './crawler-command-runner';
...
describe(CrawlerCommandRunner, () => {
    ...
    let crawlerEngine: CrawlerCommandRunner;
    ...
    beforeEach(() => {
        ...
        crawlerEngine = new CrawlerCommandRunner(
    ...
    it('Run crawler with one base url', async () => {
        ...
        await crawlerEngine.runCommand(crawlerRunOptions);
    });
