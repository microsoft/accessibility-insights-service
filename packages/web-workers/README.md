...
# Privacy Insights Service Web Workers
...
Build the [apps](https://github.com/microsoft/privacy-insights-service/tree/main/packages/web-workers) package from a command console:

```bash
        cd privacy-insights-service/packages/web-workers
        yarn build
```
...
```bash
        cd privacy-insights-service/packages/web-workers/dist
